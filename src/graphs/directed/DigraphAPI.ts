...
/**
 * Defines ADTs that are used in directed graphs' algorithms.
 */
export namespace DigraphAPI {
    /**
    ...
    export interface Digraph<V> {
         ...
         * @return {Digraph<V>} digraph with the added vertex.
         */
         ...
         * @return {Digraph<V>} digraph with the added edge.
         */
         ...
         * @param {CommonGraphAPI.Vertex<V>} v the vertex
    ...
    export interface DirectedPaths<V> {
         ...
         * path.
         * @param {CommonGraphAPI.Vertex<V>} v the vertex
         * @return {CommonsAPI.Collection<CommonGraphAPI.Vertex<V>>} the sequence of vertices on a shortest path, as a
         * Collection.
         */
    ...
    export interface DigraphSearch<V> {
         ...
         * @param {Digraph<V>} dg digraph to search.
         * @param {CommonGraphAPI.Vertex<V>} source source vertex.
         * @param {CommonGraphAPI.VertexVisitor<V>} visitor function that processes all found vetices.
         */
    ...
    export interface TopologicalOrder<V> {
         ...
         * @return {CommonsAPI.Collection<CommonGraphAPI.Vertex<V>>} a topological order of the vertices
         * (as an interable) if the digraph has a topological order (or equivalently, if the digraph is a DAG), and
         ...
         * @param {CommonGraphAPI.Vertex<V>} v vertex
    ...
    export interface DirectedEulerianPath<V> {
         ...
         * @return {CommonsAPI.Collection<CommonGraphAPI.Vertex<V>>} the sequence of vertices on an Eulerian path;
         * empty collection if no such path.
         */
    ...
    export interface StronglyConnectedComponents<V> {
         ...
         * @param {CommonGraphAPI.Vertex<V>} v one vertex
         * @param {CommonGraphAPI.Vertex<V>} w the other vertex
    ...
    export interface TransitiveClosure<V> {
         ...
         * @param {CommonGraphAPI.Vertex<V>} destination the target vertex
