import {CommonGraphBuilders, CommonGraphAPI, DigraphBuilders, DigraphAPI} from '../../../src'
...
describe('Digraph', () => {
            ...
            describe('Collection of edges', () => {
                describe('map', () => {
                    it('should return empty container for empty DG', () => {
                        expect(dg.asEdgesCollection().map(_ => {
                            throw new Error()
                        }).size()).toBe(0)
                    })
                ...
                describe('filter', () => {
                    it('should return empty container for empty DG', () => {
                        expect(dg.asEdgesCollection().filter(_ => {
                            throw new Error()
                        }).size()).toBe(0)
                    })
                ...
                describe('forEach', () => {
                    it('should not invoke HOF for empty DG', () => {
                        dg.asEdgesCollection().forEach(_ => {
                            throw new Error()
                        })
                    })
                ...
                describe('reduce', () => {
                    it('should not invoke HOF for empty DG', () => {
                        expect(dg.asEdgesCollection().reduce(() => {
                            throw new Error()
                        }, 'empty')).toBe('empty')
                    })
                    it('should invoke HOF for all edges', () => {
    ...
    describe('DG as a Container', () => {
        ...
        describe('map', () => {
            it('should return empty container for empty DG', () => {
                expect(empty.asVerticesCollection().map(_ => {
                    throw new Error()
                }).size()).toBe(0)
            })
            it('should transform every item', () => {
        ...
        describe('filter', () => {
            it('should return empty container for empty DG', () => {
                expect(empty.asVerticesCollection().filter(_ => {
                    throw new Error()
                }).size()).toBe(0)
            })
        ...
        describe('forEach', () => {
            it('should not invoke HOF for empty DG', () => {
                empty.asVerticesCollection().forEach(_ => {
                    throw new Error()
                })
            })
        ...
        describe('reduce', () => {
            it('should not invoke HOF for empty DG', () => {
                expect(empty.asVerticesCollection().reduce(() => {
                    throw new Error()
                }, 'empty')).toBe('empty')
            })
            it('should invoke HOF for all vertices', () => {
